...
### RUN in Python 3 window of ArcGIS PRO 2.8 & ArcGIS Desktop 10.7.1
...
#    x = str(i)
#    years.append(x)
#years = years + ["00", "10", "19"]
#del_fields = ["hu" + sub for sub in years]
#arcpy.management.DeleteField(t10, del_fields)
